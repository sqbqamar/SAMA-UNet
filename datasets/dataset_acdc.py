...
if __name__ == "__main__":
    ...
    base_dir = "../data/ACDC"  # Replace with the actual data directory path
    
    # Create training set
    train_set = BaseDataSets(base_dir=base_dir, split="train", transform=RandomGenerator([256, 256]))
    
    # Print number of slices in the training set
    print(f"Number of training slices: {len(train_set)}")
    
    # Optional: create a DataLoader and iterate over a few samples
